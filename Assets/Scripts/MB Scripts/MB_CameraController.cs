...
public class MB_CameraController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        player = FindObjectOfType<MB_PlayerController>();  // Find player
    ...
    void FixedUpdate()
    {
        if (player.currentState == MB_PlayerController.State.NORMAL)
        {
    ...
    void LateUpdate()
    {
        ...
        {
            case MB_PlayerController.State.WAIT:
                SpiralProcedure();
                break;
            case MB_PlayerController.State.NORMAL:
                // Follow the player
                FollowTarget();
                break;
            case MB_PlayerController.State.DEAD:
    ...
    void StartStage()
    {
        player.currentState = MB_PlayerController.State.NORMAL;
    }
